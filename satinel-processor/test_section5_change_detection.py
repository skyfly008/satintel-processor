...
async def run_tests():
    ...
    if result.change_stats.new > 0 or result.change_stats.removed > 0:
        ...
        checks.append("WARNING: No changes detected between dates")
    ...
    if result.change_stats.activity_score > 0:
        ...
        checks.append("WARNING: Activity score is zero")
    ...
    if result.change_stats.temporal_change_pct != 0:
        ...
        checks.append("WARNING: No temporal change detected")
    ...
    if result.results.get('historical_date'):
        ...
        checks.append("WARNING: Historical date not in results")
    ...
    if result_single.change_stats.new == 0 and result_single.change_stats.removed == 0:
        ...
        print("   WARNING: Unexpected change values in single-date mode")
    ...
    if result.change_stats.new > 0:
        ...
        print("\nWARNING: Check mock mask generation - may need real SAM detections")
